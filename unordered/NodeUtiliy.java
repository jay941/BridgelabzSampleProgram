...
import com.bridgelabz.unordered.Node;//for unordered programming node1
...
public class NodeUtiliy
{
 ...
 {
     try{
           FileInputStream fis = new FileInputStream("/home/bridgelabz4/jp/unordered/data.txt");
           char ch;
           String word3="";
...
{
      try{
      File fi=new File("/home/bridgelabz4/jp/unordereddata.txt");
      fi.createNewFile();
