...
import com.bridgelab.Hash.Node;//for ordered programming node2
...
public int[] integerFileReader()
    {
        try
        {
            ...
            FileReader fr = new FileReader("/home/bridgelabz4/jp/hashing/integer.txt");
...
//method to write in file
  public void writeFile(Node tNode){
    try{
            String tString="";
            File file=new File("/home/bridgelabz4/jp/hashing/NewFile.txt");
            file.createNewFile();
