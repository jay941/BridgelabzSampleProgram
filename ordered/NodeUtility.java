...
import com.bridgelabz.ordered.Node;//for ordered programming node2
...
public class NodeUtility
{
	 String[] stringArray;
  	...
  	//Reading string from file
          ...
          {
              try{
                    FileInputStream fis = new FileInputStream("/home/bridgelabz4/jp/ordered/integer.txt");
                    char ch;
                    String word3="";
...
//method to write in file
  public void writeFile(Node tNode){
    try{
            String tString="";
            File file=new File("/home/rgukt/workspace/com.bridgelabz.ordered/NewText.txt");
            file.createNewFile();
