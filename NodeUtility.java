...
public class NodeUtility
{
	 String[] stringArray;
  	...
  	//Reading string from file
          ...
          {
              try{  //reading file
                    FileInputStream fis = new FileInputStream("/home/bridgelabz4/jp/hashing/integer.txt");
                    char ch;
                    String word3="";
  ...
  {                      //converting string to integer
                    ...
                    return start;
     }//end of readfile method of string
       //read interger file
   public int[] integerFileReader()
    {
        try
        {
            ...
            FileReader fr = new FileReader("/home/bridgelabz4/jp/Program/src/com/bridgelab/task/integer.txt");//reading data from file
...
//method for adding word to node 
...
//method to write in file
  public void writeFile(Node tNode){
    try{
            String tString="";
            File file=new File("/home/bridgelabz4/jp/hashing/NewFile.txt");//reading data from file
            file.createNewFile();
